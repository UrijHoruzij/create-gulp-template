		...
		for (let lib of options.lib) {
			switch (lib) {
				...
				case 'Jquery':
					...
					writeFile(`${process.cwd()}/${pathJS}/jquery.min.js`, fileJS, 'utf8');
					break;
				case 'GSAP':
					...
					break;
				case 'Slick.js':
					fileJS = fs.readFileSync(pathNodeModules(path, '../node_modules/jquery/dist/jquery.min.js'), 'utf)8');
					writeFile(`${process.cwd()}/${pathJS}/jquery.min.js`, fileJS, 'utf8');
					fileCSS = fs.readFileSync(pathNodeModules(path, '../node_modules/slick-carousel/slick/slick.css'), 'utf)8');
