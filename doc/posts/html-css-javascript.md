...
│   ├── css                      # Site styles (less preprocessor)
│   │   └── main.css             # Main Style file
│   │   └── vendors.css           # The file for connecting library styles from the vendor folder
│   │   └── fonts.css            # The file for connecting fonts (you can use a mixin)
│   │   └── vars.css             # The file for writing css - or less-variables
